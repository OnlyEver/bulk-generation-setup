export function parseCardGenResponse(generatedData: any, isGapFill: boolean, headings: Array<any>) {
...
function parseFlashCard(data: any) {
    let displayTitle = generateFlashCardDisplayTitle(
...
function generateFlashCardDisplayTitle(front: string, back: string) {
    return `${front} ---- ${back}`;
}

function parseMcqCard(data: any) {
    let mcqAnswers = [];
    ...
    let displayTitle = generateMcqCardDisplayTitle(
...
function generateMcqCardDisplayTitle(question: string, answers: any) {
    let answersString = [];
    if (answers.length != 0) {
...
function parseClozeCard(data: any) {
    let displayTitle = generateClozeCardDisplayTitle(
        data.card_content.prompt,
...
function generateClozeCardDisplayTitle(question: string, answers: Array<any>) {
    let optionsString = '';
    if (answers.length !== 0) {
...
function parseMatchCard(cardData: any) {
...
function generateMatchCardDisplayTitle(answers: any) {
    let titles: string[] = [];
    let counter = 65;
